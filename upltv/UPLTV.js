...
var upltv = upltv || {
    ...
    */
    intSdk : function(zone, callback) {
        ...
        var vokecall = "bridgeInterface.vokeMethod";
        var callname = "bridgeInterface.initSdkCallback";
    ...
    */
    ...
    isInterstitialReadyAsyn : function(cpPlaceId, callback) {
        if (undefined != this.upltvbridge && this.upltvbridge != null) {
            ...
            if (cc.sys.os === cc.sys.OS_IOS) {
                this.upltvbridge.isIosInterstitialReadyAsyn(cpPlaceId, "bridgeInterface.vokeILReadyMethod");
            }
            else if (cc.sys.os === cc.sys.OS_ANDROID) {
                this.upltvbridge.isAndroidInterstitialReadyAsyn(cpPlaceId, "bridgeInterface.vokeILReadyMethod");
            }
        }
